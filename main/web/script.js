const translations = {
    es: {
        ...
        a2fb: {
            ...
            tqHint: "Gira a tope y APRIETA FUERTE (más de 7,5 Nm durante 3 segundos) a cada lado hasta que los dos topes estén en verde. Avanza solo.",
            s1: "Tope 1 (> 7,5 Nm)", s2: "Tope 2 (> 7,5 Nm)",
            valTitle: "Guardando la calibración",
            valHint: "Mueva el volante despacio hasta los topes de dirección.",
    ...
    en: {
        ...
        a2fb: {
            ...
            tqHint: "Turn to each stop and PUSH HARD (more than 7.5 Nm for 3 seconds) until both stops are green. It advances automatically.",
            s1: "Stop 1 (> 7.5 Nm)", s2: "Stop 2 (> 7.5 Nm)",
            valTitle: "Saving the calibration",
            valHint: "Move the wheel slowly to the steering stops.",
    ...
    fr: {
        ...
        a2fb: {
            ...
            tqHint: "Tournez en butée et APPUYEZ FORT (plus de 7,5 Nm pendant 3 secondes) de chaque côté jusqu'à ce que les deux butées soient vertes. L'avancement est automatique.",
            s1: "Butée 1 (> 7,5 Nm)", s2: "Butée 2 (> 7,5 Nm)",
            valTitle: "Enregistrement du calibrage",
            valHint: "Tournez le volant lentement jusqu'aux butées de direction.",
    ...
    de: {
        ...
        a2fb: {
            ...
            tqHint: "Bis zum Anschlag drehen und KRÄFTIG DRÜCKEN (mehr als 7,5 Nm für 3 Sekunden), auf beiden Seiten, bis beide Anschläge grün sind. Es geht automatisch weiter.",
            s1: "Anschlag 1 (> 7,5 Nm)", s2: "Anschlag 2 (> 7,5 Nm)",
            valTitle: "Kalibrierung wird gespeichert",
            valHint: "Lenkrad langsam bis zu den Lenkanschlägen drehen.",
